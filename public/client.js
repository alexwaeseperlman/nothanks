    ...
    <div class="view view-join">
      ...
      <div class="card">
        <form id="join-form">
          ...
          <input id="name-input" name="name" placeholder="Your name" maxlength="24" autocomplete="off" value="${escapeHtml(state.name)}" />
...
function renderGame() {
    ...
    <div class="view view-game">
      ...
      ${room?.state === "finished"
        ? `<div class="alert alert-success">Game over! Winner: ${escapeHtml(winnerNames.join(", ") || "Unknown")}</div>`
        : ""}
